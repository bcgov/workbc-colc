...
{
    public class DataPointCareerMap : EntityTypeConfiguration<DataPointCareer>
    {
        public DataPointCareerMap()
        {
            // Primary Key
            this.HasKey(t => t.DataPointID);
            ...
            this.ToTable("EDM_DataPointCareers");
            this.Property(t => t.DataPointID).HasColumnName("DataPointID");
