...
{
    public class ExtendedIndustryMap : EntityTypeConfiguration<ExtendedIndustry>
    {
        public ExtendedIndustryMap()
        {
            // Primary Key
            ...
            this.ToTable("vw_ExtendedIndustry", Constants.SCHEMA_NAME);
