...
set _DeploySetParametersFile=%RootPath%COLCWebsite.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%COLCWebsite.zip" (
echo "%RootPath%COLCWebsite.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%COLCWebsite.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -skip:skipaction='Delete',objectname='filePath',absolutepath='\\App_Data\\.*' -skip:skipaction='Delete',objectname='dirPath',absolutepath='\\App_Data\\.*'
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%COLCWebsite.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -skip:skipaction='Delete',objectname='filePath',absolutepath='\\App_Data\\.*' -skip:skipaction='Delete',objectname='dirPath',absolutepath='\\App_Data\\.*' -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%COLCWebsite.deploy-readme.txt" (
...
start notepad "%RootPath%COLCWebsite.deploy-readme.txt"
)
echo =========================================================
goto :eof
